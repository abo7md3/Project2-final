...
<body onload="pageloaded()">
    ...
    <div class="sidebar-main-container" id="sidebar">
        ...
        <a id="courses" href="home.php" class="sidebar-item-container noSelect">
            ...
            <a id="map" href="add.php" class="sidebar-item-container noSelect">
                <div class="sidebar-item-title">
                   ربط So & Clo
                </div>
                <svg class="sidebar-item-icon" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
...
?>
        ...
        <form action="addcloconnect.php?id=<?php echo $id; ?>" method="POST" class="main-card" id="">
        ...
        <div class="inputs">
            ...
            <div class="inputs1">
                ...
                <input onkeyup="name_change()" id="outcome" type="text" name="outcome" value="" required placeholder="CLO  " autocomplete="off">

            </div>
            <div class="inputs1">
                <label>Course learning outcome</label>
                <input onkeyup="name_change()" id="outcome1" type="text" name="outcome1" value=""  placeholder="CLO  " autocomplete="off">
